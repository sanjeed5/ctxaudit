...
SKILL_DIRS: list[dict] = [
    # -- User-level (global) --
    {"path": "~/.claude/skills", "platform": "Claude Code", "scope": "user", "readers": ["Claude Code", "Cursor"]},
    {"path": "~/.cursor/skills", "platform": "Cursor", "scope": "user"},
    {"path": "~/.cursor/skills-cursor", "platform": "Cursor", "scope": "user"},
    {"path": "~/.codex/skills", "platform": "Codex", "scope": "user", "readers": ["Codex", "Cursor"]},
    ...
    # -- Project-level --
    {
        ...
        "scope": "project",
        "readers": ["Codex", "Cursor", "Amp", "Gemini CLI", "Copilot", "OpenCode", "Cline", "Kimi CLI", "Replit"],
    },
